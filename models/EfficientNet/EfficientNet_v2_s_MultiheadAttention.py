...
class EfficientNet_v2_s_MultiheadAttention(nn.Module):
    ...
    def __init__(self):
        ...
        feature_extractor = models.efficientnet.efficientnet_v2_s(weights=models.efficientnet.EfficientNet_V2_S_Weights)
