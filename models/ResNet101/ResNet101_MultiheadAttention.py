...
class ResNet101_MultiheadAttention(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        feature_extractor = models.resnet.resnet101(pretrained=True)
        #feature_extractor = models.resnet.resnet101(norm_layer=partial(nn.BatchNorm2d, track_running_stats=False), weights=None)
