...
class ResNet152_MultiheadAttention_v2(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        feature_extractor.fc =  (
                                    nn.Linear(2048, hidden_size1) if hidden_size1 != 2048 else nn.Identity()
                                )
        ...
        self.att = nn.MultiheadAttention(hidden_size1, 32)
