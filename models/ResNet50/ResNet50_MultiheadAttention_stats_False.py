...
class ResNet50_MultiheadAttention_stats_False(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        feature_extractor = models.resnet.resnet50(norm_layer=partial(nn.BatchNorm2d, track_running_stats=False))
