...
from models.EfficientNet.EfficientNet_v2_l_MultiheadAttention import EfficientNet_v2_l_MultiheadAttention
from models.EfficientNet.EfficientNet_v2_s_MultiheadAttention import EfficientNet_v2_s_MultiheadAttention
...
transforms = {
                ...
                'Crop-Height' : {'begin': 16, 'end': 240},  # 16 - 240     # 144 - 368
                'Crop-Width' : {'begin': 16, 'end': 240},   # 16 - 240     # 144 - 368
...
model = EfficientNet_v2_l_MultiheadAttention()
model.to(device)
...
for epoch in range(NUM_EPOCHS):
    ...
    if epoch != 0 and epoch % 10 == 0:
        pos_weight_multiplier = pos_weight_multiplier / 2
    """
