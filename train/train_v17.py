...
model = ResNet152_MultiheadAttention_v3()
#ResNet152_MultiheadAttention
#model.load_state_dict(torch.load('/home/guevenira/attention_CT/PDAC/results-train/befund-verlauf-train-set5/geschlecht-1677010354/model5.pth'))
#model.load_state_dict(torch.load('/home/guevenira/attention_CT/PDAC/results-train/befund-verlauf-train-set5/geschlecht-1676916516/model9.pth'))
model.to(device)
