...
from dataset import Dataset_radimagenet
from models.ResNet18.ResNet18_rad import ResNet18_rad
...
train_dataset = Dataset_radimagenet.Dataset_radimagenet(train_ct_scans_list, train_ct_labels_list, transforms=transforms)
val_dataset = Dataset_radimagenet.Dataset_radimagenet(val_ct_scans_list, val_ct_labels_list, transforms=transforms)
test_dataset = Dataset_radimagenet.Dataset_radimagenet(test_ct_scans_list, test_ct_labels_list, transforms=transforms)
...
for epoch in range(NUM_EPOCHS):
    ...
    train_iteration = 0
    # torch.Size([1, 256, 256, 3]) torch.Size([1, 28])
