...
from dataset import Dataset_pdac_bool
...
from models.ResNet18.ResNet18_MultiheadAttention_v4 import ResNet18_MultiheadAttention_v4
...
"""
from models.ResNetXX_official_CBAM_MultiheadAttention.ResNet18_CBAM_MultiheadAttention import ResNet18_CBAM_MultiheadAttention
...
from models.Torch_ResNet_GE.ResNet18_GE_MultiheadAttention import ResNet18_GE_MultiheadAttention
from models.Torch_ResNet_GE.ResNet152_GE_MultiheadAttention import ResNet152_GE_MultiheadAttention

from models.Torch_ResNet_SE.ResNet18_SE_MultiheadAttention import ResNet18_SE_MultiheadAttention
from models.Torch_ResNet_SE.ResNet152_SE_MultiheadAttention import ResNet152_SE_MultiheadAttention

from models.Torch_ResNet_CBAM.ResNet18_CBAM_MultiheadAttention import ResNet18_CBAM_MultiheadAttention
from models.Torch_ResNet_CBAM.ResNet152_CBAM_MultiheadAttention import ResNet152_CBAM_MultiheadAttention
...
elif params_dict.get("data.label.name") == "PDAC_bool":
    file = open("../dataset/" + params_dict.get("data.label.name.version") + "/pdac_bool_0.8_train_ct_scans_list.pickle",'rb')
    train_ct_scans_list = pickle.load(file)
    file.close()

    file = open("../dataset/" + params_dict.get("data.label.name.version") + "/pdac_bool_0.8_train_ct_labels_list.pickle",'rb')
    train_ct_labels_list = pickle.load(file)
    file.close()

    file = open("../dataset/" + params_dict.get("data.label.name.version") + "/pdac_bool_0.1_val_ct_scans_list.pickle",'rb')
    val_ct_scans_list = pickle.load(file)
    file.close()

    file = open("../dataset/" + params_dict.get("data.label.name.version") + "/pdac_bool_0.1_val_ct_labels_list.pickle",'rb')
    val_ct_labels_list = pickle.load(file)
    file.close()

    file = open("../dataset/" + params_dict.get("data.label.name.version") + "/pdac_bool_0.1_test_ct_scans_list.pickle",'rb')
    test_ct_scans_list = pickle.load(file)
    file.close()

    file = open("../dataset/" + params_dict.get("data.label.name.version") + "/pdac_bool_0.1_test_ct_labels_list.pickle",'rb')
    test_ct_labels_list = pickle.load(file)
    file.close()
...
test_ct_scans_list = test_ct_scans_list + val_ct_scans_list
test_ct_labels_list = test_ct_labels_list + val_ct_labels_list

if params_dict.get("data.label.name") == "PDAC_bool":
    train_dataset = Dataset_pdac_bool.Dataset_pdac_bool(train_ct_scans_list, train_ct_labels_list, transforms=transforms, train_mode = True)
    val_dataset = Dataset_pdac_bool.Dataset_pdac_bool(val_ct_scans_list, val_ct_labels_list, transforms=transforms, train_mode = False)
    test_dataset = Dataset_pdac_bool.Dataset_pdac_bool(test_ct_scans_list, test_ct_labels_list, transforms=transforms, train_mode = False)
else:
...
# ResNet152_inter_layer_MultiheadAttention after layer 1
#model.load_state_dict(torch.load('/home/guevenira/attention_CT/PDAC/results-train/ResNet152/geschlecht-1678314115/model4.pth'))

# ResNet152_inter_layer_MultiheadAttention after layer 1 + layer 2
#model.load_state_dict(torch.load('/home/guevenira/attention_CT/PDAC/results-train/ResNet152/geschlecht-1678365525/model7.pth'))
